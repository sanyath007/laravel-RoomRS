			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="{{ url('/room/list') }}"><i class="fa fa-circle-o"></i> ห้องประชุม</a></li>
							<li><a href="{{ url('/equipment/list') }}"><i class="fa fa-circle-o"></i> อุปกรณ์ห้องประชุม</a></li>
							<!-- <li><a href="{{ url('/user/list') }}"><i class="fa fa-circle-o"></i> ผู้ใช้งาน</a></li>
							<li><a href="{{ url('/department/list') }}"><i class="fa fa-circle-o"></i> หน่วยงานผู้ใช้</a></li> -->
						</ul>
					</li>
					<!-- <li class="treeview">
						<a href="#">
