                ...
                <div class="box box-primary">
                    ...
                    <form id="frmNewRoom" name="frmNewRoom" method="post" action="{{ url('/room/store') }}" role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <!-- <div class="tab-content clearfix">
                                ...
                                <!-- <div class="tab-pane" id="2a" style="padding: 10px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">       
                                            <div class="form-group" ng-class="{ 'has-error' : frmNewRoom.supplier_credit.$invalid}">
                                                ...
                                                <div class="help-block" ng-show="frmNewRoom.supplier_credit.$error.required">
                                        ...
                                        <div class="col-md-6">       
                                            <div class="form-group" ng-class="{ 'has-error' : frmNewRoom.supplier_taxrate.$invalid}">
                                                ...
                                                <div class="help-block" ng-show="frmNewRoom.supplier_taxrate.$error.required">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">       
                                            <div class="form-group" ng-class="{ 'has-error' : frmNewRoom.supplier_agent_name.$invalid}">
                                                ...
                                                <div class="help-block" ng-show="frmNewRoom.supplier_agent_name.$error.required">
                                                    กรุณากรอกชื่อผู้ติดต่อก่อน
                                                </div>
                                            </div>

                                            <div class="form-group" ng-class="{ 'has-error' : frmNewRoom.supplier_agent_email.$invalid}">
                                                ...
                                                <div class="help-block" ng-show="frmNewRoom.supplier_agent_email.$error.required">
                                        ...
                                        <div class="col-md-6">       
                                            <div class="form-group" ng-class="{ 'has-error' : frmNewRoom.supplier_agent_contact.$invalid}">
                                                ...
                                                <div class="help-block" ng-show="frmNewRoom.supplier_agent_contact.$error.required">
                        ...
                        <div class="box-footer clearfix">
                            <button ng-click="add($event, frmNewRoom)" class="btn btn-success pull-right">
                                บันทึก
                            </button>
                        </div><!-- /.box-footer -->
                    </form>
